...
var FPS = 30;
var duracion_juego_segs = 30;
var delay_entre_frutas = 1 * FPS;


var ciclos_restantes;
var ciclos_para_nueva_fruta;
var frutas;  
...
function startGame() {
    ...
    ciclos_restantes = duracion_juego_segs * FPS;
    ciclos_para_nueva_fruta = 0;
    frutas = [];  
    status_gral.puntos = 0;
    player.x = (canvas_width/2)-16;
    player.y = (canvas_height/2)-16;
    player_rotation = 1;
